...
| Pay-into-messagebox (BRC-29 remittance) | **Used for HandCash peers** — tip / pay-sent / Send-to-friend | Remittance in chat card **and** offline `brc29:` QR/URI → `internalizeAction` wallet payment; BEEF via SPV by txid |
