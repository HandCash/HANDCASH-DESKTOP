...
* [BRC-151](./0151.md) defines an optional **latched** profile (v3 provenance, O(1) verify) for wallets that adopt Commit/Settle transfers; v2 remains valid for legacy tips.
...
10. [BRC-151](./0151.md) — Latched 1Sat Provenance for Basket `1sat` (draft)
