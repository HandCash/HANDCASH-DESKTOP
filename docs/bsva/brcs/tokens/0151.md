# BRC-151: Latched 1Sat Provenance for Basket `1sat`
...
* Publish reference script template draft (separate appendix or BRC-151a).
...
* **HandCash Desktop** (reference, phase 1): `oneSatLatch.ts`, `oneSatProvenance.verifyProvenance`, `collectables.ts`.  
  Spec: `docs/bsva/brcs/tokens/0151.md`.
