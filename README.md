...
| `refreshLegacyAddress` | Optional `{ txids, items }` from cloud; 1Sats → basket `1sat`, other UTXOs → funds; returns `{ address, satoshis, importedCount, importedItemsCount, txids }` |
