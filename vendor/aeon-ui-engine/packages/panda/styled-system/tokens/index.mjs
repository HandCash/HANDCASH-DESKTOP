const tokens = {
  ...
  "shadows.panel": {
    "value": "0 8px 32px #00000066",
    "variable": "var(--shadows-panel)"
  },
  "shadows.focusRing": {
    "value": "0 0 0 2px #0c0e12, 0 0 0 4px #5eead4",
    "variable": "var(--shadows-focus-ring)"
  },
  "spacing.0": {
    "value": "0rem",
  ...
  "spacing.controlX": {
    "value": "0.75rem",
    "variable": "var(--spacing-control-x)"
  },
  "spacing.controlY": {
    "value": "0.375rem",
    "variable": "var(--spacing-control-y)"
  },
  "spacing.controlXSm": {
    "value": "0.625rem",
    "variable": "var(--spacing-control-x-sm)"
  },
  "spacing.controlYSm": {
    "value": "0.3125rem",
    "variable": "var(--spacing-control-y-sm)"
  },
  "spacing.controlMinHXs": {
    "value": "1.75rem",
    "variable": "var(--spacing-control-min-h-xs)"
  },
  "spacing.controlMinHSm": {
    "value": "2rem",
    "variable": "var(--spacing-control-min-h-sm)"
  },
  "spacing.controlMinHMd": {
    "value": "2.25rem",
    "variable": "var(--spacing-control-min-h-md)"
  },
  "spacing.controlMinHLg": {
    "value": "2.5rem",
    "variable": "var(--spacing-control-min-h-lg)"
  },
  "spacing.badgeX": {
    "value": "0.5rem",
    "variable": "var(--spacing-badge-x)"
  },
  "spacing.badgeY": {
    "value": "0.125rem",
    "variable": "var(--spacing-badge-y)"
  },
  "spacing.insetXSm": {
    "value": "1.125rem",
    "variable": "var(--spacing-inset-x-sm)"
  },
  "spacing.insetYSm": {
    "value": "0.75rem",
    "variable": "var(--spacing-inset-y-sm)"
  },
  "spacing.insetX": {
    "value": "1.5rem",
    "variable": "var(--spacing-inset-x)"
  },
  "spacing.insetY": {
    "value": "0.875rem",
    "variable": "var(--spacing-inset-y)"
  },
  "spacing.insetXLg": {
    "value": "1.75rem",
    "variable": "var(--spacing-inset-x-lg)"
  },
  "spacing.insetYLg": {
    "value": "1.125rem",
    "variable": "var(--spacing-inset-y-lg)"
  },
  "spacing.padSm": {
    "value": "1.25rem",
    "variable": "var(--spacing-pad-sm)"
  },
  "spacing.padMd": {
    "value": "1.625rem",
    "variable": "var(--spacing-pad-md)"
  },
  "spacing.padLg": {
    "value": "2rem",
    "variable": "var(--spacing-pad-lg)"
  },
  "spacing.padXl": {
    "value": "2.5rem",
    "variable": "var(--spacing-pad-xl)"
  },
  "spacing.gapSm": {
    "value": "0.75rem",
    "variable": "var(--spacing-gap-sm)"
  },
  "spacing.gap": {
    "value": "1rem",
    "variable": "var(--spacing-gap)"
  },
  "spacing.gapLg": {
    "value": "1.25rem",
    "variable": "var(--spacing-gap-lg)"
  },
  "spacing.accordionGap": {
    "value": "0.75rem",
    "variable": "var(--spacing-accordion-gap)"
  },
  "spacing.accordionInsetX": {
    "value": "1.75rem",
    "variable": "var(--spacing-accordion-inset-x)"
  },
  "spacing.accordionTriggerY": {
    "value": "1.375rem",
    "variable": "var(--spacing-accordion-trigger-y)"
  },
  "spacing.accordionTriggerMinH": {
    "value": "3.5rem",
    "variable": "var(--spacing-accordion-trigger-min-h)"
  },
  "spacing.accordionContentY": {
    "value": "1rem",
    "variable": "var(--spacing-accordion-content-y)"
  },
  "spacing.accordionContentB": {
    "value": "1rem",
    "variable": "var(--spacing-accordion-content-b)"
  },
  "breakpoints.sm": {
    "value": "640px",
  ...
  "colors.bg": {
    "value": "var(--colors-aeon-bg)",
    "variable": "var(--colors-bg)"
  },
  "colors.surface": {
    "value": "var(--colors-aeon-surface)",
    "variable": "var(--colors-surface)"
  },
  "colors.surfaceRaised": {
    "value": "var(--colors-aeon-surface-raised)",
    "variable": "var(--colors-surface-raised)"
  },
  "colors.border": {
    "value": "var(--colors-aeon-border)",
    "variable": "var(--colors-border)"
  },
  "colors.fg": {
    "value": "var(--colors-aeon-text)",
    "variable": "var(--colors-fg)"
  },
  "colors.muted": {
    "value": "var(--colors-aeon-muted)",
    "variable": "var(--colors-muted)"
  },
  "colors.accent": {
    "value": "var(--colors-aeon-accent)",
    "variable": "var(--colors-accent)"
  },
  "colors.accentDim": {
    "value": "var(--colors-aeon-accent-dim)",
    "variable": "var(--colors-accent-dim)"
  },
  "colors.danger": {
    "value": "var(--colors-aeon-danger)",
    "variable": "var(--colors-danger)"
  },
  "colors.dangerDim": {
    "value": "var(--colors-aeon-danger-dim)",
    "variable": "var(--colors-danger-dim)"
  },
  "spacing.-1": {
  ...
  "spacing.-controlX": {
    "value": "calc(var(--spacing-control-x) * -1)",
    "variable": "var(--spacing-control-x)"
  },
  "spacing.-controlY": {
    "value": "calc(var(--spacing-control-y) * -1)",
    "variable": "var(--spacing-control-y)"
  },
  "spacing.-controlXSm": {
    "value": "calc(var(--spacing-control-x-sm) * -1)",
    "variable": "var(--spacing-control-x-sm)"
  },
  "spacing.-controlYSm": {
    "value": "calc(var(--spacing-control-y-sm) * -1)",
    "variable": "var(--spacing-control-y-sm)"
  },
  "spacing.-controlMinHXs": {
    "value": "calc(var(--spacing-control-min-h-xs) * -1)",
    "variable": "var(--spacing-control-min-h-xs)"
  },
  "spacing.-controlMinHSm": {
    "value": "calc(var(--spacing-control-min-h-sm) * -1)",
    "variable": "var(--spacing-control-min-h-sm)"
  },
  "spacing.-controlMinHMd": {
    "value": "calc(var(--spacing-control-min-h-md) * -1)",
    "variable": "var(--spacing-control-min-h-md)"
  },
  "spacing.-controlMinHLg": {
    "value": "calc(var(--spacing-control-min-h-lg) * -1)",
    "variable": "var(--spacing-control-min-h-lg)"
  },
  "spacing.-badgeX": {
    "value": "calc(var(--spacing-badge-x) * -1)",
    "variable": "var(--spacing-badge-x)"
  },
  "spacing.-badgeY": {
    "value": "calc(var(--spacing-badge-y) * -1)",
    "variable": "var(--spacing-badge-y)"
  },
  "spacing.-insetXSm": {
    "value": "calc(var(--spacing-inset-x-sm) * -1)",
    "variable": "var(--spacing-inset-x-sm)"
  },
  "spacing.-insetYSm": {
    "value": "calc(var(--spacing-inset-y-sm) * -1)",
    "variable": "var(--spacing-inset-y-sm)"
  },
  "spacing.-insetX": {
    "value": "calc(var(--spacing-inset-x) * -1)",
    "variable": "var(--spacing-inset-x)"
  },
  "spacing.-insetY": {
    "value": "calc(var(--spacing-inset-y) * -1)",
    "variable": "var(--spacing-inset-y)"
  },
  "spacing.-insetXLg": {
    "value": "calc(var(--spacing-inset-x-lg) * -1)",
    "variable": "var(--spacing-inset-x-lg)"
  },
  "spacing.-insetYLg": {
    "value": "calc(var(--spacing-inset-y-lg) * -1)",
    "variable": "var(--spacing-inset-y-lg)"
  },
  "spacing.-padSm": {
    "value": "calc(var(--spacing-pad-sm) * -1)",
    "variable": "var(--spacing-pad-sm)"
  },
  "spacing.-padMd": {
    "value": "calc(var(--spacing-pad-md) * -1)",
    "variable": "var(--spacing-pad-md)"
  },
  "spacing.-padLg": {
    "value": "calc(var(--spacing-pad-lg) * -1)",
    "variable": "var(--spacing-pad-lg)"
  },
  "spacing.-padXl": {
    "value": "calc(var(--spacing-pad-xl) * -1)",
    "variable": "var(--spacing-pad-xl)"
  },
  "spacing.-gapSm": {
    "value": "calc(var(--spacing-gap-sm) * -1)",
    "variable": "var(--spacing-gap-sm)"
  },
  "spacing.-gap": {
    "value": "calc(var(--spacing-gap) * -1)",
    "variable": "var(--spacing-gap)"
  },
  "spacing.-gapLg": {
    "value": "calc(var(--spacing-gap-lg) * -1)",
    "variable": "var(--spacing-gap-lg)"
  },
  "spacing.-accordionGap": {
    "value": "calc(var(--spacing-accordion-gap) * -1)",
    "variable": "var(--spacing-accordion-gap)"
  },
  "spacing.-accordionInsetX": {
    "value": "calc(var(--spacing-accordion-inset-x) * -1)",
    "variable": "var(--spacing-accordion-inset-x)"
  },
  "spacing.-accordionTriggerY": {
    "value": "calc(var(--spacing-accordion-trigger-y) * -1)",
    "variable": "var(--spacing-accordion-trigger-y)"
  },
  "spacing.-accordionTriggerMinH": {
    "value": "calc(var(--spacing-accordion-trigger-min-h) * -1)",
    "variable": "var(--spacing-accordion-trigger-min-h)"
  },
  "spacing.-accordionContentY": {
    "value": "calc(var(--spacing-accordion-content-y) * -1)",
    "variable": "var(--spacing-accordion-content-y)"
  },
  "spacing.-accordionContentB": {
    "value": "calc(var(--spacing-accordion-content-b) * -1)",
    "variable": "var(--spacing-accordion-content-b)"
  },
  "colors.colorPalette": {
