...
export interface Conditions {
	...
	"_aeonSelected": string
	/** `&[data-aeon-state~="checked"]` */
	"_aeonChecked": string
	/** `&[data-aeon-state=open]` */
	"_aeonOpen": string
	/** `&[data-aeon-state=closed]` */
	"_aeonClosed": string
	/** `&[data-aeon-state=expanded]` */
	"_aeonExpanded": string
	/** `&[data-aeon-state=collapsed]` */
	"_aeonCollapsed": string
	/** `&[data-aeon-state=overlayOpen]` */
	"_aeonOverlayOpen": string
	/** `&[data-aeon-state=floating]` */
	"_aeonFloating": string
	/** `&[data-aeon-state=docked]` */
	"_aeonDocked": string
	/** `&[data-aeon-state=hidden]` */
	"_aeonHidden": string
	/** `&[data-aeon-state=ready]` */
	"_aeonReady": string
	/** `&[data-aeon-state=empty]` */
	"_aeonEmpty": string
	/** `&[data-aeon-state=active]` */
	"_aeonActive": string
	/** `&[data-aeon-state=inactive]` */
	"_aeonInactive": string
	/** `&[data-aeon-state=pending]` */
	"_aeonPending": string
	/** `&[data-aeon-state=success]` */
	"_aeonSuccess": string
	/** `&[data-aeon-state=failure]` */
	"_aeonFailure": string
	/** `&[data-aeon-state*=invalid]` */
	"_aeonInvalid": string
